% =========================================================================
% Function Name: cal_SHE_areas
% Description: Calculate time series of areas for all SHE projection ellipses
...
function area_series = cal_SHE_areas(coeff_SHE_series, data_length)

% data_length = size(coeff_SHE_series, 1);
area_series = zeros(data_length,12);

for i = 1:data_length%对每一帧
    for j = 1: 12
        a = sqrt(1 / coeff_SHE_series(i,1,j));
        b = sqrt(1 / coeff_SHE_series(i,2,j));
